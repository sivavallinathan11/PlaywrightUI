...
test('Select reservation then change room and pay using cash then checkin', async ({page, request}) => {
    ...
    // Initialize Test
    var testDetails = await baseSteps.InitializeTestResultDirectory("PW-2375-GR-pay-group-reservation-using-cash-then-do-group-checkin");
    ...
    //const groupBookingNumber = payGroupBookingUsingCash.groupBookingNumber;
    ...
    var paymentData = await manageGroup.SelectPaymentMethodAndVerifyPaymentDetails("Cash", dashboardData);
