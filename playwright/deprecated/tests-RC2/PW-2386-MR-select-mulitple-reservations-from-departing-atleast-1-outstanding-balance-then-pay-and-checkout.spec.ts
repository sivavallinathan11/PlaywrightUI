...
test('Select multiple reservation from departing with at least 1 outstanding balance then pay and checkout', async ({page, request}) => {
    ...
    // Initialize Test
    var testDetails = await baseSteps.InitializeTestResultDirectory("PW-2386-MR-select-mulitple-reservations-from-departing-atleast-1-outstanding-balance-then-pay-and-checkout");
    ...
    var reservations = await apiHelper.CreateMultipleReservations("Multiple Departing", 
    "Booking Number", 3, 2);
