...
test('Add discount to a single booking where assigned guest is a NON-MEMBER', async({page, request}) =>{
    // Set base object.
    const baseSteps = new BaseSteps();

    // Initialize directory for test.
    const testDetails = await baseSteps.InitializeTestResultDirectory("PW-3802-AddDiscountToBookingUsingNonMember");
