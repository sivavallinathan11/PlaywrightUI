...
test('Select unpaid and NOT clean reservation then checkin', async ({page, request}) => {
    // Set basesteps object.
    const baseSteps = new BaseSteps(); 

    // Initialize Test
    var testDetails = await baseSteps.InitializeTestResultDirectory("PW-2344-SR-checkin-unpaid-reservation-with-room-NOT-clean");
    ...
    var reservationNumber = await apiHelper.CreateReservation("Not Clean", "Booking Number");
