...
test('Add membership of paid reservation claim all benefits then pay using eftpos and checkin', async ({page, request}) => {
    // Set basesteps object.
    const baseSteps = new BaseSteps(); 

    // Initialize Test
    var testDetails = await baseSteps.InitializeTestResultDirectory("PW-2362-SR-buy-membership-for-paid-reservation-and-pay-using-eftpos-then-checkin");
