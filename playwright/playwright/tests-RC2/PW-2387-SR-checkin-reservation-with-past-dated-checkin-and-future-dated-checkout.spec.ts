...
test('Checkin a reservation with past dated checkin and future dated checkout', async ({page, request}) => {
    ...
    //#region Start test.
    //Create a reservation that has past dated checkin and future dated checkout
    var reservationNumber = await apiHelper.CreateReservation("Past Dated Checkin", "Booking Number");
    ...
    var dashboardData = await dashboard.SelectSpecificReservation("Reservation Number", reservationNumber, "Search");
