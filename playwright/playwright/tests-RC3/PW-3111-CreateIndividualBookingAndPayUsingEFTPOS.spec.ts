...
test('Create and pay an individual booking using EFTPOS', async({page, request}) =>{
    // Set base object.
    const baseSteps = new BaseSteps();

    // Initialize directory for test.
    const testDetails = await baseSteps.InitializeTestResultDirectory("PW-3111-CreateIndividualBookingAndPayUsingEFTPOS");
