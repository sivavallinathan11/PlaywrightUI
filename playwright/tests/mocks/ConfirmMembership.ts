export const confirmmembership = {
    ...
    <input data-val="true" data-val-required="First Name is required" id="customer-card-firstname" name="FirstName" type="hidden" value="asdf" />
    <input data-val="true" data-val-required="Surname is required" id="LastName" name="LastName" type="hidden" value="asdf" />
    <input data-val="true" data-val-regex="Invalid Email" data-val-regex-pattern="^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$" data-val-required="The Email field is required." id="Email" name="Email" type="hidden" value="asdfasdf@asdfads.com" />
    <input data-val="true" data-val-required="Phone Number is required" data-val-validateauphonenumber="The field Contact Number is invalid." data-val-validateauphonenumber-dependentproperty="CountryCode" id="Phone" name="Phone" type="hidden" value="+61401789783" />
    <input data-val="true" data-val-required="Street is required" id="Street" name="Street" type="hidden" value="asdf" />
    <input data-val="true" data-val-required="Town is required" id="Town" name="Town" type="hidden" value="asdf" />
    <input id="State" name="State" type="hidden" value="NSW" />
    <input data-val="true" data-val-regex="Valid postcode required" data-val-regex-pattern="^[0-9]*$" data-val-requiredif="Postcode is required" data-val-requiredif-dependentproperty="gr-country" data-val-requiredif-desiredvalue="AU" id="PostCode" name="PostCode" type="hidden" value="5000" />
    <input data-val="true" data-val-required="Country is required" id="Country" name="Country" type="hidden" value="AU" />
    <input id="LoyaltyTier" name="LoyaltyTier" type="hidden" value="Mate" />
    ...
    <input data-val="true" data-val-required="The IsActiveMember field is required." id="is-active-member" name="IsActiveMember" type="hidden" value="True" />
    <input data-val="true" data-val-required="The IsUpsell field is required." id="is-upsell" name="IsUpsell" type="hidden" value="True" />
    <input id="StaffName" name="StaffName" type="hidden" value="asdf" />
    ...
    <div id="gr-contact-card">
        <div class="gr-guest-details">
            ...
            <span class="gr-guest-email">asdfasdf@asdfads.com</span>
            <span class="gr-guest-phone">+61401789783</span>
        </div>
        <div class="gr-gday-rewards">
            <div class="gr-rewards-icon gday-mate">
                <img />
            </div>
            <div class="gr-gday">
                <span class="gr-rewards-title">G'day Rewards</span>
                <span class="gr-rewards-tier">Mate</span>
            </div>
        </div>
