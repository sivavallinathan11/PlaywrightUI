...
<input data-val="true" data-val-required="First Name is required" id="customer-card-firstname" name="FirstName" type="hidden" value="Just a Test" />
<input data-val="true" data-val-required="Surname is required" id="LastName" name="LastName" type="hidden" value="Just a Test" />
<input data-val="true" data-val-regex="Invalid Email" data-val-regex-pattern="^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$" data-val-required="The Email field is required." id="Email" name="Email" type="hidden" value="just@atest.com" />
<input data-val="true" data-val-required="Phone Number is required" data-val-validateauphonenumber="The field Contact Number is invalid." data-val-validateauphonenumber-dependentproperty="CountryCode" id="Phone" name="Phone" type="hidden" value="+61401217010" />
...
<input id="StaffName" name="StaffName" type="hidden" value="Test Robot" />
...
<div id="gr-contact-card">
	<div class="gr-guest-details">
		<div class="gr-guest-name">
			<h3>Just a Test Just a Test</h3>
		</div>
		<span class="gr-guest-email">just@atest.com</span>
		<span class="gr-guest-phone">+61401217010</span>
	</div>
