export const openconfirmmembership = {
    body: `
<form action="/" id="confirm-membership-form" method="post"><input data-val="true" data-val-number="The field ReservationId must be a number." data-val-required="The ReservationId field is required." id="reservation-id" name="ReservationId" type="hidden" value="353184" /><input data-val="true" data-val-number="The field Price must be a number." data-val-required="The Price field is required." id="SelectedAccommodation_Price" name="SelectedAccommodation.Price" type="hidden" value="150" /><input data-val="true" data-val-required="First Name is required" id="FirstName" name="FirstName" type="hidden" value="RCATSMemberZDQBQ554" /><input data-val="true" data-val-required="Surname is required" id="LastName" name="LastName" type="hidden" value="RCATSMemberTestelOml616" /><input data-val="true" data-val-regex="Invalid Email" data-val-regex-pattern="^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$" data-val-required="The Email field is required." id="Email" name="Email" type="hidden" value="RCATSMembersCOhn960@gmail.com" /><input data-val="true" data-val-required="Phone Number is required" data-val-validateauphonenumber="The field Contact Number is invalid." data-val-validateauphonenumber-dependentproperty="CountryCode" id="Phone" name="Phone" type="hidden" value="+61412345678" /><input data-val="true" data-val-required="Street is required" id="Street" name="Street" type="hidden" value="Light Square" /><input data-val="true" data-val-required="Town is required" id="Town" name="Town" type="hidden" value="Adelaide" /><input id="State" name="State" type="hidden" value="SA" /><input class="input-validation-error" data-val="true" data-val-regex="Valid postcode required" data-val-regex-pattern="^[0-9]*$" data-val-requiredif="Postcode is required" data-val-requiredif-dependentproperty="gr-country" data-val-requiredif-desiredvalue="AU" id="PostCode" name="PostCode" type="hidden" value="5000" /><input data-val="true" data-val-required="Country is required" id="Country" name="Country" type="hidden" value="AU" /><input data-val="true" data-val-required="The MemberGuid field is required." id="MemberGuid" name="MemberGuid" type="hidden" value="00000000-0000-0000-0000-000000000000" /><input id="ClientId" name="ClientId" type="hidden" value="" /><input id="MemberExpirationDate" name="MemberExpirationDate" type="hidden" value="" /><input id="LoyaltyTier" name="LoyaltyTier" type="hidden" value="" /><input id="MembershipNumber" name="MembershipNumber" type="hidden" value="" />	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="header">
				<span>Mocked Confirm Membership</span>
			</div>
