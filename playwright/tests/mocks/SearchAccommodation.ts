export const accoms = {
        ...
        <div class="nr-title">
            <div class="col-md-8">
                <h2>Search Results</h2>
                    <p>Mocked accommodation between <b>15 Jul 23 - 16 Jul 23</b></p>
            </div>
        ...
        <td>
            ...
            <div class="col-md-10 search-result-details">
                ...
                <div class="accommodation-info">
                    <p class="status"><i class="fas fa-circle"></i> <span id="cabins-available">48 Available</span></p><i class="fas fa-info-circle accommInfoIcon"></i>
                </div>
            </div>
        </td>
        <td>
            <div class="col-md-12 u-ph-0 search-result-total">
                <p class="cost">$32.7 <span>total</span></p>
    ...
    <form action="/Booking/AddBooking" id="add-booking-3" method="post"><input data-val="true" data-val-date="The field CheckInDate must be a date." data-val-required="The CheckInDate field is required." id="CheckInDate" name="CheckInDate" type="hidden" value="15/07/2023 2:00:00 PM" /><input data-val="true" data-val-date="The field CheckOutDate must be a date." data-val-required="The CheckOutDate field is required." id="CheckOutDate" name="CheckOutDate" type="hidden" value="16/07/2023 10:00:00 AM" /><input id="SelectedAccommodation_Images" name="SelectedAccommodation.Images" type="hidden" value="https://stratweb-gdaygroup.imgix.net/getmedia/940778fe-3d70-48c2-98ea-70589a0b3f61/test-1.jpg?width=2000&amp;height=1335&amp;ext=.jpg" /><input id="SelectedAccommodation_Name" name="SelectedAccommodation.Name" type="hidden" value="Superior Two Bedroom Cabin" /><input data-val="true" data-val-number="The field NoOfCabins must be a number." data-val-required="The NoOfCabins field is required." id="SelectedAccommodation_NoOfCabins" name="SelectedAccommodation.NoOfCabins" type="hidden" value="3" /><input id="SelectedAccommodation_RoomTypeId" name="SelectedAccommodation.RoomTypeId" type="hidden" value="TEST-1-38-RT" /><input data-val="true" data-val-number="The field SelectedAccommodationId must be a number." data-val-required="The SelectedAccommodationId field is required." id="accommodation-id" name="SelectedAccommodationId" type="hidden" value="3" /><input data-val="true" data-val-number="The field AdultCount must be a number." data-val-required="The AdultCount field is required." id="AdultCount" name="AdultCount" type="hidden" value="2" /><input data-val="true" data-val-number="The field ChildCount must be a number." data-val-required="The ChildCount field is required." id="ChildCount" name="ChildCount" type="hidden" value="1" /><input data-val="true" data-val-number="The field InfantCount must be a number." data-val-required="The InfantCount field is required." id="InfantCount" name="InfantCount" type="hidden" value="1" /><input data-val="true" data-val-required="The IsCabins field is required." id="IsCabins" name="IsCabins" type="hidden" value="False" /><input data-val="true" data-val-required="The IsSites field is required." id="IsSites" name="IsSites" type="hidden" value="False" /><input data-val="true" data-val-required="The IsPetFriendly field is required." id="IsPetFriendly" name="IsPetFriendly" type="hidden" value="False" /><input data-val="true" data-val-number="The field Price must be a number." data-val-required="The Price field is required." id="accommodation-price" name="SelectedAccommodation.Price" type="hidden" value="135" /><input id="SelectedAccommodation_Availability" name="SelectedAccommodation.Availability" type="hidden" value="2023-07-15T00:00:00+00:00@120" /><input id="SelectedAccommodation_ChargeTypeId" name="SelectedAccommodation.ChargeTypeId" type="hidden" value="42" /><input data-val="true" data-val-number="The field AdditionalAdultAmount must be a number." data-val-required="The AdditionalAdultAmount field is required." id="SelectedAccommodation_AdditionalAdultAmount" name="SelectedAccommodation.AdditionalAdultAmount" type="hidden" value="0" /><input data-val="true" data-val-number="The field AdditionalChildAmount must be a number." data-val-required="The AdditionalChildAmount field is required." id="SelectedAccommodation_AdditionalChildAmount" name="SelectedAccommodation.AdditionalChildAmount" type="hidden" value="15" /><input data-val="true" data-val-number="The field AdditionalInfantAmount must be a number." data-val-required="The AdditionalInfantAmount field is required." id="SelectedAccommodation_AdditionalInfantAmount" name="SelectedAccommodation.AdditionalInfantAmount" type="hidden" value="0" /><input data-val="true" data-val-number="The field BaseRate must be a number." data-val-required="The BaseRate field is required." id="SelectedAccommodation_BaseRate" name="SelectedAccommodation.BaseRate" type="hidden" value="120" /><input data-val="true" data-val-number="The field MemberPrice must be a number." data-val-required="The MemberPrice field is required." id="SelectedAccommodation_MemberPrice" name="SelectedAccommodation.MemberPrice" type="hidden" value="121.5" /></form>
        ...
        <td>
            ...
            <div class="col-md-10 search-result-details">
                <input id="room-type-id" name="SelectedAccommodation.RoomTypeId" type="hidden" value="TEST-1-38-RT" />
                <p class="title">Superior Two Bedroom Cabin</p>
                <div class="accommodation-info">
    ...
    <form action="/Booking/AddBooking" id="add-booking-4" method="post"><input data-val="true" data-val-date="The field CheckInDate must be a date." data-val-required="The CheckInDate field is required." id="CheckInDate" name="CheckInDate" type="hidden" value="15/07/2023 2:00:00 PM" /><input data-val="true" data-val-date="The field CheckOutDate must be a date." data-val-required="The CheckOutDate field is required." id="CheckOutDate" name="CheckOutDate" type="hidden" value="16/07/2023 10:00:00 AM" /><input id="SelectedAccommodation_Images" name="SelectedAccommodation.Images" type="hidden" value="/Content/Images/cabin1.png" /><input id="SelectedAccommodation_Name" name="SelectedAccommodation.Name" type="hidden" value="Superior One Bedroom Cabin Sleeps 3" /><input data-val="true" data-val-number="The field NoOfCabins must be a number." data-val-required="The NoOfCabins field is required." id="SelectedAccommodation_NoOfCabins" name="SelectedAccommodation.NoOfCabins" type="hidden" value="2" /><input id="SelectedAccommodation_RoomTypeId" name="SelectedAccommodation.RoomTypeId" type="hidden" value="TEST-1-43-RT" /><input data-val="true" data-val-number="The field SelectedAccommodationId must be a number." data-val-required="The SelectedAccommodationId field is required." id="accommodation-id" name="SelectedAccommodationId" type="hidden" value="4" /><input data-val="true" data-val-number="The field AdultCount must be a number." data-val-required="The AdultCount field is required." id="AdultCount" name="AdultCount" type="hidden" value="2" /><input data-val="true" data-val-number="The field ChildCount must be a number." data-val-required="The ChildCount field is required." id="ChildCount" name="ChildCount" type="hidden" value="1" /><input data-val="true" data-val-number="The field InfantCount must be a number." data-val-required="The InfantCount field is required." id="InfantCount" name="InfantCount" type="hidden" value="1" /><input data-val="true" data-val-required="The IsCabins field is required." id="IsCabins" name="IsCabins" type="hidden" value="False" /><input data-val="true" data-val-required="The IsSites field is required." id="IsSites" name="IsSites" type="hidden" value="False" /><input data-val="true" data-val-required="The IsPetFriendly field is required." id="IsPetFriendly" name="IsPetFriendly" type="hidden" value="False" /><input data-val="true" data-val-number="The field Price must be a number." data-val-required="The Price field is required." id="accommodation-price" name="SelectedAccommodation.Price" type="hidden" value="135" /><input id="SelectedAccommodation_Availability" name="SelectedAccommodation.Availability" type="hidden" value="2023-07-15T00:00:00+00:00@120" /><input id="SelectedAccommodation_ChargeTypeId" name="SelectedAccommodation.ChargeTypeId" type="hidden" value="42" /><input data-val="true" data-val-number="The field AdditionalAdultAmount must be a number." data-val-required="The AdditionalAdultAmount field is required." id="SelectedAccommodation_AdditionalAdultAmount" name="SelectedAccommodation.AdditionalAdultAmount" type="hidden" value="0" /><input data-val="true" data-val-number="The field AdditionalChildAmount must be a number." data-val-required="The AdditionalChildAmount field is required." id="SelectedAccommodation_AdditionalChildAmount" name="SelectedAccommodation.AdditionalChildAmount" type="hidden" value="15" /><input data-val="true" data-val-number="The field AdditionalInfantAmount must be a number." data-val-required="The AdditionalInfantAmount field is required." id="SelectedAccommodation_AdditionalInfantAmount" name="SelectedAccommodation.AdditionalInfantAmount" type="hidden" value="0" /><input data-val="true" data-val-number="The field BaseRate must be a number." data-val-required="The BaseRate field is required." id="SelectedAccommodation_BaseRate" name="SelectedAccommodation.BaseRate" type="hidden" value="120" /><input data-val="true" data-val-number="The field MemberPrice must be a number." data-val-required="The MemberPrice field is required." id="SelectedAccommodation_MemberPrice" name="SelectedAccommodation.MemberPrice" type="hidden" value="121.5" /></form>
        ...
        <td hidden>
    <form action="/Booking/AddBooking" id="add-booking-5" method="post"><input data-val="true" data-val-date="The field CheckInDate must be a date." data-val-required="The CheckInDate field is required." id="CheckInDate" name="CheckInDate" type="hidden" value="15/07/2023 2:00:00 PM" /><input data-val="true" data-val-date="The field CheckOutDate must be a date." data-val-required="The CheckOutDate field is required." id="CheckOutDate" name="CheckOutDate" type="hidden" value="16/07/2023 10:00:00 AM" /><input id="SelectedAccommodation_Images" name="SelectedAccommodation.Images" type="hidden" value="/Content/Images/cabin1.png" /><input id="SelectedAccommodation_Name" name="SelectedAccommodation.Name" type="hidden" value="Superior One Bedroom Cabin Sleeps 5" /><input data-val="true" data-val-number="The field NoOfCabins must be a number." data-val-required="The NoOfCabins field is required." id="SelectedAccommodation_NoOfCabins" name="SelectedAccommodation.NoOfCabins" type="hidden" value="2" /><input id="SelectedAccommodation_RoomTypeId" name="SelectedAccommodation.RoomTypeId" type="hidden" value="TEST-1-8-RT" /><input data-val="true" data-val-number="The field SelectedAccommodationId must be a number." data-val-required="The SelectedAccommodationId field is required." id="accommodation-id" name="SelectedAccommodationId" type="hidden" value="5" /><input data-val="true" data-val-number="The field AdultCount must be a number." data-val-required="The AdultCount field is required." id="AdultCount" name="AdultCount" type="hidden" value="2" /><input data-val="true" data-val-number="The field ChildCount must be a number." data-val-required="The ChildCount field is required." id="ChildCount" name="ChildCount" type="hidden" value="1" /><input data-val="true" data-val-number="The field InfantCount must be a number." data-val-required="The InfantCount field is required." id="InfantCount" name="InfantCount" type="hidden" value="1" /><input data-val="true" data-val-required="The IsCabins field is required." id="IsCabins" name="IsCabins" type="hidden" value="False" /><input data-val="true" data-val-required="The IsSites field is required." id="IsSites" name="IsSites" type="hidden" value="False" /><input data-val="true" data-val-required="The IsPetFriendly field is required." id="IsPetFriendly" name="IsPetFriendly" type="hidden" value="False" /><input data-val="true" data-val-number="The field Price must be a number." data-val-required="The Price field is required." id="accommodation-price" name="SelectedAccommodation.Price" type="hidden" value="135" /><input id="SelectedAccommodation_Availability" name="SelectedAccommodation.Availability" type="hidden" value="2023-07-15T00:00:00+00:00@120" /><input id="SelectedAccommodation_ChargeTypeId" name="SelectedAccommodation.ChargeTypeId" type="hidden" value="42" /><input data-val="true" data-val-number="The field AdditionalAdultAmount must be a number." data-val-required="The AdditionalAdultAmount field is required." id="SelectedAccommodation_AdditionalAdultAmount" name="SelectedAccommodation.AdditionalAdultAmount" type="hidden" value="0" /><input data-val="true" data-val-number="The field AdditionalChildAmount must be a number." data-val-required="The AdditionalChildAmount field is required." id="SelectedAccommodation_AdditionalChildAmount" name="SelectedAccommodation.AdditionalChildAmount" type="hidden" value="15" /><input data-val="true" data-val-number="The field AdditionalInfantAmount must be a number." data-val-required="The AdditionalInfantAmount field is required." id="SelectedAccommodation_AdditionalInfantAmount" name="SelectedAccommodation.AdditionalInfantAmount" type="hidden" value="0" /><input data-val="true" data-val-number="The field BaseRate must be a number." data-val-required="The BaseRate field is required." id="SelectedAccommodation_BaseRate" name="SelectedAccommodation.BaseRate" type="hidden" value="120" /><input data-val="true" data-val-number="The field MemberPrice must be a number." data-val-required="The MemberPrice field is required." id="SelectedAccommodation_MemberPrice" name="SelectedAccommodation.MemberPrice" type="hidden" value="121.5" /></form>
        </td>
        ...
        <td hidden>
    <form action="/Booking/AddBooking" id="add-booking-6" method="post"><input data-val="true" data-val-date="The field CheckInDate must be a date." data-val-required="The CheckInDate field is required." id="CheckInDate" name="CheckInDate" type="hidden" value="15/07/2023 2:00:00 PM" /><input data-val="true" data-val-date="The field CheckOutDate must be a date." data-val-required="The CheckOutDate field is required." id="CheckOutDate" name="CheckOutDate" type="hidden" value="16/07/2023 10:00:00 AM" /><input id="SelectedAccommodation_Images" name="SelectedAccommodation.Images" type="hidden" value="/Content/Images/cabin1.png" /><input id="SelectedAccommodation_Name" name="SelectedAccommodation.Name" type="hidden" value="Standard Studio Cabin" /><input data-val="true" data-val-number="The field NoOfCabins must be a number." data-val-required="The NoOfCabins field is required." id="SelectedAccommodation_NoOfCabins" name="SelectedAccommodation.NoOfCabins" type="hidden" value="6" /><input id="SelectedAccommodation_RoomTypeId" name="SelectedAccommodation.RoomTypeId" type="hidden" value="TEST-1-7-RT" /><input data-val="true" data-val-number="The field SelectedAccommodationId must be a number." data-val-required="The SelectedAccommodationId field is required." id="accommodation-id" name="SelectedAccommodationId" type="hidden" value="6" /><input data-val="true" data-val-number="The field AdultCount must be a number." data-val-required="The AdultCount field is required." id="AdultCount" name="AdultCount" type="hidden" value="2" /><input data-val="true" data-val-number="The field ChildCount must be a number." data-val-required="The ChildCount field is required." id="ChildCount" name="ChildCount" type="hidden" value="1" /><input data-val="true" data-val-number="The field InfantCount must be a number." data-val-required="The InfantCount field is required." id="InfantCount" name="InfantCount" type="hidden" value="1" /><input data-val="true" data-val-required="The IsCabins field is required." id="IsCabins" name="IsCabins" type="hidden" value="False" /><input data-val="true" data-val-required="The IsSites field is required." id="IsSites" name="IsSites" type="hidden" value="False" /><input data-val="true" data-val-required="The IsPetFriendly field is required." id="IsPetFriendly" name="IsPetFriendly" type="hidden" value="False" /><input data-val="true" data-val-number="The field Price must be a number." data-val-required="The Price field is required." id="accommodation-price" name="SelectedAccommodation.Price" type="hidden" value="150" /><input id="SelectedAccommodation_Availability" name="SelectedAccommodation.Availability" type="hidden" value="2023-07-15T00:00:00+00:00@135" /><input id="SelectedAccommodation_ChargeTypeId" name="SelectedAccommodation.ChargeTypeId" type="hidden" value="42" /><input data-val="true" data-val-number="The field AdditionalAdultAmount must be a number." data-val-required="The AdditionalAdultAmount field is required." id="SelectedAccommodation_AdditionalAdultAmount" name="SelectedAccommodation.AdditionalAdultAmount" type="hidden" value="0" /><input data-val="true" data-val-number="The field AdditionalChildAmount must be a number." data-val-required="The AdditionalChildAmount field is required." id="SelectedAccommodation_AdditionalChildAmount" name="SelectedAccommodation.AdditionalChildAmount" type="hidden" value="15" /><input data-val="true" data-val-number="The field AdditionalInfantAmount must be a number." data-val-required="The AdditionalInfantAmount field is required." id="SelectedAccommodation_AdditionalInfantAmount" name="SelectedAccommodation.AdditionalInfantAmount" type="hidden" value="0" /><input data-val="true" data-val-number="The field BaseRate must be a number." data-val-required="The BaseRate field is required." id="SelectedAccommodation_BaseRate" name="SelectedAccommodation.BaseRate" type="hidden" value="135" /><input data-val="true" data-val-number="The field MemberPrice must be a number." data-val-required="The MemberPrice field is required." id="SelectedAccommodation_MemberPrice" name="SelectedAccommodation.MemberPrice" type="hidden" value="135" /></form>
        </td>
        ...
        <td>
            <div class="col-md-12 u-ph-0 search-result-total">
                <p class="cost">$150 <span>total</span></p>
                <p class="nights">1 night/s</p>
            </div>
        </td>
        <td>
        ...
        <td hidden>
    <form action="/Booking/AddBooking" id="add-booking-7" method="post"><input data-val="true" data-val-date="The field CheckInDate must be a date." data-val-required="The CheckInDate field is required." id="CheckInDate" name="CheckInDate" type="hidden" value="15/07/2023 2:00:00 PM" /><input data-val="true" data-val-date="The field CheckOutDate must be a date." data-val-required="The CheckOutDate field is required." id="CheckOutDate" name="CheckOutDate" type="hidden" value="16/07/2023 10:00:00 AM" /><input id="SelectedAccommodation_Images" name="SelectedAccommodation.Images" type="hidden" value="/Content/Images/cabin1.png" /><input id="SelectedAccommodation_Name" name="SelectedAccommodation.Name" type="hidden" value="Standard One Bedroom Cabin" /><input data-val="true" data-val-number="The field NoOfCabins must be a number." data-val-required="The NoOfCabins field is required." id="SelectedAccommodation_NoOfCabins" name="SelectedAccommodation.NoOfCabins" type="hidden" value="3" /><input id="SelectedAccommodation_RoomTypeId" name="SelectedAccommodation.RoomTypeId" type="hidden" value="TEST-1-5-RT" /><input data-val="true" data-val-number="The field SelectedAccommodationId must be a number." data-val-required="The SelectedAccommodationId field is required." id="accommodation-id" name="SelectedAccommodationId" type="hidden" value="7" /><input data-val="true" data-val-number="The field AdultCount must be a number." data-val-required="The AdultCount field is required." id="AdultCount" name="AdultCount" type="hidden" value="2" /><input data-val="true" data-val-number="The field ChildCount must be a number." data-val-required="The ChildCount field is required." id="ChildCount" name="ChildCount" type="hidden" value="1" /><input data-val="true" data-val-number="The field InfantCount must be a number." data-val-required="The InfantCount field is required." id="InfantCount" name="InfantCount" type="hidden" value="1" /><input data-val="true" data-val-required="The IsCabins field is required." id="IsCabins" name="IsCabins" type="hidden" value="False" /><input data-val="true" data-val-required="The IsSites field is required." id="IsSites" name="IsSites" type="hidden" value="False" /><input data-val="true" data-val-required="The IsPetFriendly field is required." id="IsPetFriendly" name="IsPetFriendly" type="hidden" value="False" /><input data-val="true" data-val-number="The field Price must be a number." data-val-required="The Price field is required." id="accommodation-price" name="SelectedAccommodation.Price" type="hidden" value="155" /><input id="SelectedAccommodation_Availability" name="SelectedAccommodation.Availability" type="hidden" value="2023-07-15T00:00:00+00:00@140" /><input id="SelectedAccommodation_ChargeTypeId" name="SelectedAccommodation.ChargeTypeId" type="hidden" value="42" /><input data-val="true" data-val-number="The field AdditionalAdultAmount must be a number." data-val-required="The AdditionalAdultAmount field is required." id="SelectedAccommodation_AdditionalAdultAmount" name="SelectedAccommodation.AdditionalAdultAmount" type="hidden" value="0" /><input data-val="true" data-val-number="The field AdditionalChildAmount must be a number." data-val-required="The AdditionalChildAmount field is required." id="SelectedAccommodation_AdditionalChildAmount" name="SelectedAccommodation.AdditionalChildAmount" type="hidden" value="15" /><input data-val="true" data-val-number="The field AdditionalInfantAmount must be a number." data-val-required="The AdditionalInfantAmount field is required." id="SelectedAccommodation_AdditionalInfantAmount" name="SelectedAccommodation.AdditionalInfantAmount" type="hidden" value="0" /><input data-val="true" data-val-number="The field BaseRate must be a number." data-val-required="The BaseRate field is required." id="SelectedAccommodation_BaseRate" name="SelectedAccommodation.BaseRate" type="hidden" value="140" /><input data-val="true" data-val-number="The field MemberPrice must be a number." data-val-required="The MemberPrice field is required." id="SelectedAccommodation_MemberPrice" name="SelectedAccommodation.MemberPrice" type="hidden" value="139.5" /></form>
        </td>
        ...
        <td>
            <div class="col-md-12 u-ph-0 search-result-total">
                <p class="cost">$155 <span>total</span></p>
                <p class="nights">1 night/s</p>
            </div>
        </td>
        <td>
        ...
        <td hidden>
    <form action="/Booking/AddBooking" id="add-booking-8" method="post"><input data-val="true" data-val-date="The field CheckInDate must be a date." data-val-required="The CheckInDate field is required." id="CheckInDate" name="CheckInDate" type="hidden" value="15/07/2023 2:00:00 PM" /><input data-val="true" data-val-date="The field CheckOutDate must be a date." data-val-required="The CheckOutDate field is required." id="CheckOutDate" name="CheckOutDate" type="hidden" value="16/07/2023 10:00:00 AM" /><input id="SelectedAccommodation_Images" name="SelectedAccommodation.Images" type="hidden" value="/Content/Images/cabin1.png" /><input id="SelectedAccommodation_Name" name="SelectedAccommodation.Name" type="hidden" value="Superior Two Bedroom Access Cabin" /><input data-val="true" data-val-number="The field NoOfCabins must be a number." data-val-required="The NoOfCabins field is required." id="SelectedAccommodation_NoOfCabins" name="SelectedAccommodation.NoOfCabins" type="hidden" value="1" /><input id="SelectedAccommodation_RoomTypeId" name="SelectedAccommodation.RoomTypeId" type="hidden" value="TEST-1-40-RT" /><input data-val="true" data-val-number="The field SelectedAccommodationId must be a number." data-val-required="The SelectedAccommodationId field is required." id="accommodation-id" name="SelectedAccommodationId" type="hidden" value="8" /><input data-val="true" data-val-number="The field AdultCount must be a number." data-val-required="The AdultCount field is required." id="AdultCount" name="AdultCount" type="hidden" value="2" /><input data-val="true" data-val-number="The field ChildCount must be a number." data-val-required="The ChildCount field is required." id="ChildCount" name="ChildCount" type="hidden" value="1" /><input data-val="true" data-val-number="The field InfantCount must be a number." data-val-required="The InfantCount field is required." id="InfantCount" name="InfantCount" type="hidden" value="1" /><input data-val="true" data-val-required="The IsCabins field is required." id="IsCabins" name="IsCabins" type="hidden" value="False" /><input data-val="true" data-val-required="The IsSites field is required." id="IsSites" name="IsSites" type="hidden" value="False" /><input data-val="true" data-val-required="The IsPetFriendly field is required." id="IsPetFriendly" name="IsPetFriendly" type="hidden" value="False" /><input data-val="true" data-val-number="The field Price must be a number." data-val-required="The Price field is required." id="accommodation-price" name="SelectedAccommodation.Price" type="hidden" value="195" /><input id="SelectedAccommodation_Availability" name="SelectedAccommodation.Availability" type="hidden" value="2023-07-15T00:00:00+00:00@180" /><input id="SelectedAccommodation_ChargeTypeId" name="SelectedAccommodation.ChargeTypeId" type="hidden" value="42" /><input data-val="true" data-val-number="The field AdditionalAdultAmount must be a number." data-val-required="The AdditionalAdultAmount field is required." id="SelectedAccommodation_AdditionalAdultAmount" name="SelectedAccommodation.AdditionalAdultAmount" type="hidden" value="0" /><input data-val="true" data-val-number="The field AdditionalChildAmount must be a number." data-val-required="The AdditionalChildAmount field is required." id="SelectedAccommodation_AdditionalChildAmount" name="SelectedAccommodation.AdditionalChildAmount" type="hidden" value="15" /><input data-val="true" data-val-number="The field AdditionalInfantAmount must be a number." data-val-required="The AdditionalInfantAmount field is required." id="SelectedAccommodation_AdditionalInfantAmount" name="SelectedAccommodation.AdditionalInfantAmount" type="hidden" value="0" /><input data-val="true" data-val-number="The field BaseRate must be a number." data-val-required="The BaseRate field is required." id="SelectedAccommodation_BaseRate" name="SelectedAccommodation.BaseRate" type="hidden" value="180" /><input data-val="true" data-val-number="The field MemberPrice must be a number." data-val-required="The MemberPrice field is required." id="SelectedAccommodation_MemberPrice" name="SelectedAccommodation.MemberPrice" type="hidden" value="175.5" /></form>
        </td>
        ...
        <td>
            <div class="col-md-12 u-ph-0 search-result-total">
                <p class="cost">$195 <span>total</span></p>
                <p class="nights">1 night/s</p>
            </div>
        </td>
        <td>
    ...
    <form action="/Booking/AddBooking" id="add-booking-9" method="post"><input data-val="true" data-val-date="The field CheckInDate must be a date." data-val-required="The CheckInDate field is required." id="CheckInDate" name="CheckInDate" type="hidden" value="15/07/2023 2:00:00 PM" /><input data-val="true" data-val-date="The field CheckOutDate must be a date." data-val-required="The CheckOutDate field is required." id="CheckOutDate" name="CheckOutDate" type="hidden" value="16/07/2023 10:00:00 AM" /><input id="SelectedAccommodation_Images" name="SelectedAccommodation.Images" type="hidden" value="https://stratweb-gdaygroup.imgix.net/getmedia/9d0af8ba-0296-4634-9e3c-e28768296cc3/testimage_8.jpg?width=648&amp;height=376&amp;ext=.jpg" /><input id="SelectedAccommodation_Name" name="SelectedAccommodation.Name" type="hidden" value="Deluxe Poolview 2 Bedroom TEST2" /><input data-val="true" data-val-number="The field NoOfCabins must be a number." data-val-required="The NoOfCabins field is required." id="SelectedAccommodation_NoOfCabins" name="SelectedAccommodation.NoOfCabins" type="hidden" value="6" /><input id="SelectedAccommodation_RoomTypeId" name="SelectedAccommodation.RoomTypeId" type="hidden" value="TEST-1-49-RT" /><input data-val="true" data-val-number="The field SelectedAccommodationId must be a number." data-val-required="The SelectedAccommodationId field is required." id="accommodation-id" name="SelectedAccommodationId" type="hidden" value="9" /><input data-val="true" data-val-number="The field AdultCount must be a number." data-val-required="The AdultCount field is required." id="AdultCount" name="AdultCount" type="hidden" value="2" /><input data-val="true" data-val-number="The field ChildCount must be a number." data-val-required="The ChildCount field is required." id="ChildCount" name="ChildCount" type="hidden" value="1" /><input data-val="true" data-val-number="The field InfantCount must be a number." data-val-required="The InfantCount field is required." id="InfantCount" name="InfantCount" type="hidden" value="1" /><input data-val="true" data-val-required="The IsCabins field is required." id="IsCabins" name="IsCabins" type="hidden" value="False" /><input data-val="true" data-val-required="The IsSites field is required." id="IsSites" name="IsSites" type="hidden" value="False" /><input data-val="true" data-val-required="The IsPetFriendly field is required." id="IsPetFriendly" name="IsPetFriendly" type="hidden" value="False" /><input data-val="true" data-val-number="The field Price must be a number." data-val-required="The Price field is required." id="accommodation-price" name="SelectedAccommodation.Price" type="hidden" value="235" /><input id="SelectedAccommodation_Availability" name="SelectedAccommodation.Availability" type="hidden" value="2023-07-15T00:00:00+00:00@220" /><input id="SelectedAccommodation_ChargeTypeId" name="SelectedAccommodation.ChargeTypeId" type="hidden" value="42" /><input data-val="true" data-val-number="The field AdditionalAdultAmount must be a number." data-val-required="The AdditionalAdultAmount field is required." id="SelectedAccommodation_AdditionalAdultAmount" name="SelectedAccommodation.AdditionalAdultAmount" type="hidden" value="0" /><input data-val="true" data-val-number="The field AdditionalChildAmount must be a number." data-val-required="The AdditionalChildAmount field is required." id="SelectedAccommodation_AdditionalChildAmount" name="SelectedAccommodation.AdditionalChildAmount" type="hidden" value="15" /><input data-val="true" data-val-number="The field AdditionalInfantAmount must be a number." data-val-required="The AdditionalInfantAmount field is required." id="SelectedAccommodation_AdditionalInfantAmount" name="SelectedAccommodation.AdditionalInfantAmount" type="hidden" value="0" /><input data-val="true" data-val-number="The field BaseRate must be a number." data-val-required="The BaseRate field is required." id="SelectedAccommodation_BaseRate" name="SelectedAccommodation.BaseRate" type="hidden" value="220" /><input data-val="true" data-val-number="The field MemberPrice must be a number." data-val-required="The MemberPrice field is required." id="SelectedAccommodation_MemberPrice" name="SelectedAccommodation.MemberPrice" type="hidden" value="211.5" /></form>
        ...
        <td>
            <div class="col-md-12 u-ph-0 search-result-total">
                <p class="cost">$235 <span>total</span></p>
                <p class="nights">1 night/s</p>
            </div>
        </td>
        <td>
        ...
        <td hidden>
    <form action="/Booking/AddBooking" id="add-booking-10" method="post"><input data-val="true" data-val-date="The field CheckInDate must be a date." data-val-required="The CheckInDate field is required." id="CheckInDate" name="CheckInDate" type="hidden" value="15/07/2023 2:00:00 PM" /><input data-val="true" data-val-date="The field CheckOutDate must be a date." data-val-required="The CheckOutDate field is required." id="CheckOutDate" name="CheckOutDate" type="hidden" value="16/07/2023 10:00:00 AM" /><input id="SelectedAccommodation_Images" name="SelectedAccommodation.Images" type="hidden" value="/Content/Images/cabin1.png" /><input id="SelectedAccommodation_Name" name="SelectedAccommodation.Name" type="hidden" value="TEST-1-3-RT" /><input data-val="true" data-val-number="The field NoOfCabins must be a number." data-val-required="The NoOfCabins field is required." id="SelectedAccommodation_NoOfCabins" name="SelectedAccommodation.NoOfCabins" type="hidden" value="3" /><input id="SelectedAccommodation_RoomTypeId" name="SelectedAccommodation.RoomTypeId" type="hidden" value="TEST-1-3-RT" /><input data-val="true" data-val-number="The field SelectedAccommodationId must be a number." data-val-required="The SelectedAccommodationId field is required." id="accommodation-id" name="SelectedAccommodationId" type="hidden" value="10" /><input data-val="true" data-val-number="The field AdultCount must be a number." data-val-required="The AdultCount field is required." id="AdultCount" name="AdultCount" type="hidden" value="2" /><input data-val="true" data-val-number="The field ChildCount must be a number." data-val-required="The ChildCount field is required." id="ChildCount" name="ChildCount" type="hidden" value="1" /><input data-val="true" data-val-number="The field InfantCount must be a number." data-val-required="The InfantCount field is required." id="InfantCount" name="InfantCount" type="hidden" value="1" /><input data-val="true" data-val-required="The IsCabins field is required." id="IsCabins" name="IsCabins" type="hidden" value="False" /><input data-val="true" data-val-required="The IsSites field is required." id="IsSites" name="IsSites" type="hidden" value="False" /><input data-val="true" data-val-required="The IsPetFriendly field is required." id="IsPetFriendly" name="IsPetFriendly" type="hidden" value="False" /><input data-val="true" data-val-number="The field Price must be a number." data-val-required="The Price field is required." id="accommodation-price" name="SelectedAccommodation.Price" type="hidden" value="315" /><input id="SelectedAccommodation_Availability" name="SelectedAccommodation.Availability" type="hidden" value="2023-07-15T00:00:00+00:00@300" /><input id="SelectedAccommodation_ChargeTypeId" name="SelectedAccommodation.ChargeTypeId" type="hidden" value="42" /><input data-val="true" data-val-number="The field AdditionalAdultAmount must be a number." data-val-required="The AdditionalAdultAmount field is required." id="SelectedAccommodation_AdditionalAdultAmount" name="SelectedAccommodation.AdditionalAdultAmount" type="hidden" value="0" /><input data-val="true" data-val-number="The field AdditionalChildAmount must be a number." data-val-required="The AdditionalChildAmount field is required." id="SelectedAccommodation_AdditionalChildAmount" name="SelectedAccommodation.AdditionalChildAmount" type="hidden" value="15" /><input data-val="true" data-val-number="The field AdditionalInfantAmount must be a number." data-val-required="The AdditionalInfantAmount field is required." id="SelectedAccommodation_AdditionalInfantAmount" name="SelectedAccommodation.AdditionalInfantAmount" type="hidden" value="0" /><input data-val="true" data-val-number="The field BaseRate must be a number." data-val-required="The BaseRate field is required." id="SelectedAccommodation_BaseRate" name="SelectedAccommodation.BaseRate" type="hidden" value="300" /><input data-val="true" data-val-number="The field MemberPrice must be a number." data-val-required="The MemberPrice field is required." id="SelectedAccommodation_MemberPrice" name="SelectedAccommodation.MemberPrice" type="hidden" value="283.5" /></form>
        </td>
        ...
        <td>
            <div class="col-md-12 u-ph-0 search-result-total">
                <p class="cost">$315 <span>total</span></p>
                <p class="nights">1 night/s</p>
            </div>
        </td>
        <td>
