...
test('Create a group booking then pay partially using EFTPOS', async({page, request}) => {
    // Set basesteps object.
    const baseSteps = new BaseSteps();

    // Initialize directory for test.
    const testDetails = await baseSteps.InitializeTestResultDirectory("PW-3167-CreateGroupBookingThenPayPartiallyUsingEFTPOS");
