...
test('Add better offer to 1st and 2nd booking then join gday', async({page, request}) =>{
    // Set base object.
    const baseSteps = new BaseSteps();

    // Initialize directory for test.
    const testDetails = await baseSteps.InitializeTestResultDirectory("PW-4328-AddBetterOfferTo1stBookingAnd2ndBookingThenJoinGDay");
